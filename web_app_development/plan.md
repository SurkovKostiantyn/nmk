...
#### Завдання до лекції 11 [Практичне завдання до Лекції №11: Глобальне керування станом](practical_task_11.md)
...
### 7. Впровадження TypeScript ([Лабораторне заняття 7. 2 години](lab_07.md))

Повний рефакторинг коду лабораторних робіт з додаванням типізації для підвищення надійності системи.

### 8. Написання тестів ([Лабораторне заняття 8. 2 години](lab_08.md))
