...
1. Скриншот списку об'єктів у кошику після завантаження всіх файлів (хмарна консоль або MinIO Browser / `mc ls`)
2. Посилання на публічний об'єкт та скриншот його відкриття в браузері (хмарний URL або `http://localhost:9000/...`)
3. Вивід команди перегляду версій об'єкта: мінімум 3 версії (`aws s3api list-object-versions` або `mc ls --versions`)
4. Скриншот налаштованої Lifecycle Policy (Management Console або вивід `mc ilm ls`)
