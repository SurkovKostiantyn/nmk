...
## Варіант 3. Backblaze B2 (Хмарне S3-сумісне сховище) [https://www.backblaze.com/b2/cloud-storage.html]
...
1. Перейдіть у розділ **Account** -> **Application Keys**.
...
```powershell
# Налаштуйте ключі (keyID -> Access Key, applicationKey -> Secret Key)
aws configure

# Завантаження (змініть Endpoint на свій з Кроку 1)
$ENDPOINT = "https://s3.us-west-004.backblazeb2.com"
$BUCKET = "lab05-b2-<ваш-логін>"

aws s3 cp public.txt s3://$BUCKET/ --endpoint-url $ENDPOINT
