...
Навчитись підключати зовнішні таблиці стилів до HTML-документа. Опанувати базові CSS-селектори, роботу з кольорами, шрифтами (типографікою) та фоновими зображеннями для стилізації веб сторінки.
