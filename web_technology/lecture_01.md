...
2.  High Performance Browser Networking by Ilya Grigorik (Чудова книга від експерта Google про архітектуру мереж) ([https://hpbn.co/](https://hpbn.co/)).
3.  Офіційна документація MDN: HTTP status codes ([https://developer.mozilla.org/en-US/docs/Web/HTTP/Status](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status))
4.  Cloudflare Learning Hub: Що таке DNS? ([https://www.cloudflare.com/learning/dns/what-is-dns/](https://www.cloudflare.com/learning/dns/what-is-dns/))
5.  Як працює Web: Mozilla Developer Network ([https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/How_the_Web_works](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/How_the_Web_works))
