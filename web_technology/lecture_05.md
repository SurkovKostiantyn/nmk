...
![Основи CSS Grid: fr та template](media/grid_layout_basics.png)
...
![Розміщення елементів на Grid за лініями](media/grid_item_placement.png)
...
![Візуалізація адаптивного дизайну (Desktop vs Mobile)](media/media_queries_responsive.png)
